    ...
    public static void check() {
        ...
        if (FlyBuff.isPreview()) {
            try {
                ...
                try {
                    ...
                    System.err.println(Color.color("&b[FlyBuff 开发渠道更新] &f>>> &e正在使用的FlyBuff-DEV版本: " + FlyBuff.instance.getDescription().getVersion()));
                    System.err.println(Color.color(" &c无法检查更新"));
                    return;
                }
            }
            if (!sb.toString().equals(FlyBuff.instance.getDescription().getVersion())) {
                System.err.println(Color.color("&b[FlyBuff 开发渠道更新] &f>>> &e正在使用的FlyBuff-DEV版本: " + FlyBuff.instance.getDescription().getVersion()));
                System.err.println(Color.color(" &a最新开发版本: " + sb.toString() + " 请前往GitHub更新"));
            } else {
                System.out.println(Color.color("&b[FlyBuff 开发渠道更新] &f>>> &e正在使用的FlyBuff-DEV版本: " + FlyBuff.instance.getDescription().getVersion()));
        ...
        try {
            ...
            try {
                ...
                System.err.println(Color.color("&b[FlyBuff 更新] &f>>> &e正在使用的FlyBuff版本: " + FlyBuff.instance.getDescription().getVersion()));
                System.err.println(Color.color(" &c无法检查更新"));
                return;
            }
        }
        if (!sb.toString().equals(FlyBuff.instance.getDescription().getVersion())) {
            ...
            System.out.println(Color.color("&b[FlyBuff 更新] &f>>> &e正在使用的FlyBuff版本: " + FlyBuff.instance.getDescription().getVersion()));
